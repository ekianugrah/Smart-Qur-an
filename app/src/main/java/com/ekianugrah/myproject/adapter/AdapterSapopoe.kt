...
import com.ekianugrah.myproject.adapter.AdapterSapopoe.ListViewHolder
import com.ekianugrah.myproject.main.ModelSapopoe
import kotlinx.android.synthetic.main.item_sapopoe.view.*
import java.util.*

class AdapterSapopoe(private val context: Context, private val modelBacaan: MutableList<ModelSapopoe>) :
    RecyclerView.Adapter<ListViewHolder>(), Filterable {

    var modelBacaanListFull: List<ModelSapopoe>
    ...
    private val modelBacaanFilter: Filter = object : Filter() {
        override fun performFiltering(constraint: CharSequence): FilterResults {
            val filteredList: MutableList<ModelSapopoe> = ArrayList()
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ListViewHolder {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.item_sapopoe, viewGroup, false)
