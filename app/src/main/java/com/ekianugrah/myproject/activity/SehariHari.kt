...
import com.ekianugrah.myproject.adapter.AdapterSapopoe
import com.ekianugrah.myproject.main.ModelSapopoe
import kotlinx.android.synthetic.main.sapopoe.*
...
class SehariHari : AppCompatActivity() {
    var adapterDoa: AdapterSapopoe? = null
    var modelSapopoe: MutableList<ModelSapopoe> = ArrayList()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.sapopoe)
        ...
        try {
            ...
            try {
                ...
                for (i in 0 until jsonArray.length()) {
                    ...
                    modelSapopoe.add(dataModel)
                }
                adapterDoa = AdapterSapopoe(this, modelSapopoe)
