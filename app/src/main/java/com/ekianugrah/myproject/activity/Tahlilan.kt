...
import com.ekianugrah.myproject.adapter.AdapterDoa
import com.ekianugrah.myproject.main.ModelDoa
import kotlinx.android.synthetic.main.tahlilan.*
...
import java.util.*
    ...
    class Tahlilan : AppCompatActivity() {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            setContentView(R.layout.tahlilan)
            ...
            val searchPlateId = searchDoa.getContext().resources.getIdentifier(
